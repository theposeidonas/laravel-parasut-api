 ...
 */
class Salary extends ParasutV4
{
    /**
     * @var string
     */
    ...
    public function __construct($config)
    {
        ...
        $this->serviceUrl = $this->config['api_url'].$this->config['company_id'].'/salaries';
    }
    ...
    public function index(array $parameters = []): array
    {
        Validator::validate($parameters, [
            ...
            'include' => 'nullable|string|in:category,tags,payments,activities,employee',
        ]);
    ...
    {
        Validator::validate($parameters, [
            'include' => 'nullable|string|in:employee,category,tags'
        ]);
